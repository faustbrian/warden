...
interface ClipboardInterface
{
     ...
     * @param BackedEnum|string $ability   The ability name to check (e.g., 'edit', 'delete', 'publish')
     ...
     */
    public function checkGetId(Model $authority, BackedEnum|string $ability, Model|string|null $model = null): null|bool|int|string;
     ...
     * @param array<int, BackedEnum|int|Role|string>|int|Role|string $roles     Single role name or array of role names/IDs/instances to check
