...
use Cline\Warden\Exceptions\ColumnsAndOperatorMustBeStringsException;
...
final class ColumnConstraint extends Constraint
{
     ...
     *
     * @throws ColumnsAndOperatorMustBeStringsException If columns or operator are not strings
     *
    ...
    public static function fromData(array $data): static
    {
        ...
        throw_if(!is_string($a) || !is_string($operator) || !is_string($b), ColumnsAndOperatorMustBeStringsException::forColumnConstraint());
