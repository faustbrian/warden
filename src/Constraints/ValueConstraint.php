...
use Cline\Warden\Exceptions\ColumnAndOperatorMustBeStringsException;
...
final class ValueConstraint extends Constraint
{
    ...
    public static function fromData(array $data): static
    {
        ...
        throw_if(!is_string($column) || !is_string($operator), ColumnAndOperatorMustBeStringsException::forValueConstraint());
