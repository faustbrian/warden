...
final class Warden
{
     ...
     *
     * @param  Model|string   $authority The user model or model class to grant abilities to
     * @return GivesAbilities Conductor for completing the ability grant
     */
    ...
    {
        return new RemovesAbilities();
    }

    /**
     * Begin a fluent chain to explicitly forbid abilities for an authority.
     *
     * Unlike removal, forbidding creates an explicit denial that will override
     * any grants from roles or other sources.
     *
     * @param  Model|string     $authority The user model or model class to forbid abilities for
     ...
     * @return AssignsRoles                                            Conductor for completing the role assignment
     */
     ...
     *
     * If already using a cached clipboard, updates its cache store. Otherwise,
     * replaces the current clipboard with a new CachedClipboard instance.
     *
     ...
     * forcing all permission checks to query the database.
     *
     * @return $this
     */
     ...
     *
     * When enabled, Warden's permission checks will run before policies, allowing
     * Warden rules to override policy logic. When disabled (default), policies
     * take precedence.
     *
     * @param  bool  $boolean Whether to run before policies
     * @return $this
     */
     ...
     *
     * Allows customization of ownership checks used for "owned" permission scoping.
     * Can specify attribute names or custom closures to determine ownership.
     *
     * @param  Closure|string      $model     The model class or closure
     * @param  null|Closure|string $attribute The ownership attribute or closure
     * @return $this
     */
