 ...
 * @method static Response               authorize(BackedEnum|string $ability, array|mixed $arguments = [])                                                    Authorize ability or throw exception
 * @method static self                   cache(?Store $cache = null)                                                                                           Enable clipboard caching with custom store
 * @method static bool                   can(BackedEnum|string $ability, array|mixed $arguments = [])                                                          Check if ability is allowed
 * @method static bool                   canAny(array<int, BackedEnum|string> $abilities, array|mixed $arguments = [])                                         Check if any abilities are allowed
 * @method static bool                   denies(BackedEnum|string $ability, array|mixed $arguments = []) Check if ability is denied (deprecated, use cannot())
