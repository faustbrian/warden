...
/**
 * Defines supported primary key types for Warden models.
 *
 * This enum represents the available primary key generation strategies that can
 * be used with Warden's role and ability models. Each type corresponds to a
 * different identifier format with specific characteristics and use cases.
 *
