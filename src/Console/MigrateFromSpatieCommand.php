 ...
 * laravel-permission package to Warden's authorization system. The migration
 * process preserves all role and permission relationships while converting
 * them to Warden's data structure for seamless transition.
 *
...
final class MigrateFromSpatieCommand extends Command
{
     ...
     * then delegates the actual migration work to the SpatieMigrator. Ensures
    ...
    public function handle(Repository $config): int
    {
        ...
        $migrationTracking = $config->get('warden.migrators.spatie.migration_tracking', [
            'enabled' => false,
            'column' => 'migrated_at',
        ]);
