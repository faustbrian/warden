...
use Cline\Warden\Exceptions\ModelDoesNotExistException;
...
trait FindsAndCreatesAbilities
{
     ...
     * instances exist in the database to prevent unintended universal grants. This
     * validation prevents a common mistake where passing a non-persisted model would
     * inadvertently grant universal permissions instead of instance-specific ones.
     *
     * @param Model|string $model Model instance, class name, or wildcard
     *
     * @throws ModelDoesNotExistException If a non-existent model instance is provided
     *
    ...
    protected function getEntityInstance(Model|string $model): Model|string
    {
        ...
        throw_unless($model->exists, ModelDoesNotExistException::useClassNameInstead());
