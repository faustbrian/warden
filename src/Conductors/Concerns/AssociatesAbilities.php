...
trait AssociatesAbilities
{
     ...
     *
     * @return null|\Cline\Warden\Conductors\Lazy\ConductsAbilities Lazy conductor for chaining when only ability names provided, otherwise null after immediate execution
     */
    ...
    protected function getAssociatedAbilityIds($authority, array $abilityIds): array
    {
        ...
        $relation->whereIn($table.'.id', $abilityIds)
            ->wherePivot('forbidden', '=', $this->forbidding); // @phpstan-ignore-line method.nonObject
