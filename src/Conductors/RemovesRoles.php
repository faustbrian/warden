...
final readonly class RemovesRoles
{
     ...
     */
    public function __construct(array|BackedEnum|Collection|Role|string $roles)
    {
     ...
     * @return Collection<int, int> Collection of role IDs corresponding to the given names
     */
