...
final class UnforbidsAbilities
{
     ...
     * removed when detaching, preserving any granted abilities associated with
     * the authority. This separation allows independent management of explicit
     * denials and permission grants.
     *
     * @var array<string, bool>
     */
    protected array $constraints = ['forbidden' => true];
     ...
     *                                     a string identifier representing a role name that will
     *                                     be resolved to a Role model, or null to be set later
     *                                     via trait methods.
