...
use Cline\Warden\Exceptions\UserModelNotConfiguredException;
use Closure;
 ...
 *
 * Morph key functionality is delegated to Morphism MorphKeyRegistry.
 *
...
final class ModelRegistry
{
    ...
    public function __construct(
        private readonly MorphKeyRegistry $morphKeyRegistry,
    ) {}
    ...
    public function user(array $attributes = []): Model
    {
        ...
        throw UserModelNotConfiguredException::callSetUsersModelFirst();
    }
     ...
     *
     * Delegates to Morphism MorphKeyRegistry.
     *
     ...
     * Does not affect the scope instance. Also resets the morph key registry.
     */
