...
trait Authorizable
{
     ...
     * ```
     *
     * @param  string     $ability The ability name to check (e.g., 'edit', 'delete')
     ...
     */
    public function can(string $ability, Model|string|null $model = null): bool
    {
     ...
     */
    public function cant(string $ability, Model|string|null $model = null): bool
    {
     ...
     * @return bool              True if the authority lacks the ability, false if they have it
     */
    public function cannot(string $ability, Model|string|null $model = null): bool
    {
