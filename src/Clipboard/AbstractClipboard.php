...
use Cline\Warden\Exceptions\ModelMustHaveRolesMethodException;
...
abstract class AbstractClipboard implements ClipboardInterface
{
     ...
     * @param array<int, BackedEnum|int|Role|string>|BackedEnum|int|Role|string $roles     Role name(s), IDs, or instances to check against
     ...
     */
    public function checkRole(Model $authority, array|BackedEnum|Role|int|string $roles, string $boolean = 'or'): bool
    {
    ...
    {
        throw_unless(method_exists($authority, 'roles'), ModelMustHaveRolesMethodException::forAuthority());
     ...
     * @param array<int, BackedEnum|int|Role|string>|BackedEnum|int|Role|string $roles     Role identifiers to match against (names, IDs, or models)
     *
     ...
     */
    protected function countMatchingRoles(Model $authority, array|BackedEnum|Role|int|string $roles): int
    {
