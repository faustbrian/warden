...
abstract class AbstractClipboard implements ClipboardInterface
{
     ...
     * @param  string            $ability   The ability name to verify (e.g., 'create', 'update', 'delete')
     ...
     *
     * @throws InvalidArgumentException If a role identifier type is not supported
     *
