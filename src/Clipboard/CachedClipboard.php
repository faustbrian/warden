...
final class CachedClipboard extends AbstractClipboard implements CachedClipboardInterface
{
     ...
     */
    private function findMatchingAbility(Collection|BaseCollection $abilities, BaseCollection $applicable, mixed $model, Model $authority): int|null
    {
     ...
     * @return int|null                    The matched ability ID, or null if no match
     */
    private function getMatchedAbilityId(BaseCollection $abilityMap, BaseCollection $applicable): int|null
    {
