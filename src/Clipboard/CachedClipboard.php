...
final class CachedClipboard extends AbstractClipboard implements CachedClipboardInterface
{
     ...
     * @param  BaseCollection<int, mixed>                        $applicable Compiled ability identifiers to match against
     ...
     */
    private function findMatchingAbility(BaseCollection|Collection $abilities, BaseCollection $applicable, mixed $model, Model $authority): ?int
    {
        ...
        if ($this->isOwnedBy($authority, $model)) {
            return $this->getMatchedAbilityId(
                $abilities,
                /** @phpstan-ignore-next-line argument.type */
                $applicable->map(function ($identifier): string {
     ...
     *
     * @param  BaseCollection<int, mixed> $abilityMap Map of ability IDs to their identifiers
     * @param  BaseCollection<int, mixed> $applicable Collection of applicable ability identifiers
