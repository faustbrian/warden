...
use Cline\Warden\Exceptions\UnsupportedLogicalOperatorException;
...
final class Helpers
{
     ...
     *
     * @throws UnsupportedLogicalOperatorException When the operator is not 'and' or 'or'
     */
    public static function ensureValidLogicalOperator(string $operator): void
    {
        if (!in_array($operator, ['and', 'or'], true)) {
            throw UnsupportedLogicalOperatorException::forOperator($operator);
        }
    }
