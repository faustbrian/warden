...
return [
    ...
    */
    ...
    'actor_morph_type' => env('WARDEN_ACTOR_MORPH_TYPE', 'string'),
    'boundary_morph_type' => env('WARDEN_BOUNDARY_MORPH_TYPE', 'string'),
    'subject_morph_type' => env('WARDEN_SUBJECT_MORPH_TYPE', 'string'),
    /*
    |--------------------------------------------------------------------------
    ...
    */
    ...
    'morphKeyMap' => [
        ...
        // Cline\Warden\Database\Role::class => 'id',
        // Cline\Warden\Database\Ability::class => 'id',
    ],
    /*
    |--------------------------------------------------------------------------
    ...
    'migrators' => [
        ...
        */
        ...
        'bouncer' => [
            ...
            'migration_tracking' => [
                'enabled' => env('WARDEN_BOUNCER_TRACK_MIGRATED_AT', false),
                'column' => env('WARDEN_BOUNCER_MIGRATED_AT_COLUMN', 'migrated_at'),
            ],
        ],
        /*
        |----------------------------------------------------------------------
        ...
        */
        ...
        'spatie' => [
            ...
            'migration_tracking' => [
                'enabled' => env('WARDEN_SPATIE_TRACK_MIGRATED_AT', false),
                'column' => env('WARDEN_SPATIE_MIGRATED_AT_COLUMN', 'migrated_at'),
            ],
        ],
    ],
];
