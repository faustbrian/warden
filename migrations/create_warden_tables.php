...
return new class() extends Migration
{
    ...
    public function up(): void
    {
        ...
        $actorMorphType = MorphType::tryFrom(config('warden.actor_morph_type', 'string')) ?? MorphType::String;
        $boundaryMorphType = MorphType::tryFrom(config('warden.boundary_morph_type', 'string')) ?? MorphType::String;
        $subjectMorphType = MorphType::tryFrom(config('warden.subject_morph_type', 'string')) ?? MorphType::String;
        ...
        Schema::create(Models::table('abilities'), function (Blueprint $table) use ($primaryKeyType, $subjectMorphType, $boundaryMorphType): void {
            ...
            match ($subjectMorphType) {
                ...
                MorphType::String => $table->nullableMorphs('subject'),
            };
        ...
        Schema::create(Models::table('assigned_roles'), function (Blueprint $table) use ($primaryKeyType, $actorMorphType, $boundaryMorphType): void {
            ...
            match ($actorMorphType) {
                ...
                MorphType::String => $table->morphs('actor'),
            };
            ...
            match ($actorMorphType) {
                ...
                MorphType::String => $table->nullableMorphs('restricted_to'),
            };
        ...
        Schema::create(Models::table('permissions'), function (Blueprint $table) use ($primaryKeyType, $actorMorphType, $boundaryMorphType): void {
            ...
            match ($actorMorphType) {
                ...
                MorphType::String => $table->nullableMorphs('actor'),
            };
