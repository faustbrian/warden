...
test\:docker\:sqlite\:id: build
	docker-compose run --rm -e DB_CONNECTION=sqlite -e WARDEN_PRIMARY_KEY_TYPE=id php85 vendor/bin/pest $(ARGS)

test\:docker\:sqlite\:numeric: build
	docker-compose run --rm -e DB_CONNECTION=sqlite -e WARDEN_PRIMARY_KEY_TYPE=id -e WARDEN_ACTOR_MORPH_TYPE=numeric -e WARDEN_BOUNDARY_MORPH_TYPE=numeric -e WARDEN_SUBJECT_MORPH_TYPE=numeric php85 vendor/bin/pest --configuration=phpunit.numeric.xml $(ARGS)

test\:docker\:sqlite\:ulid: build
	docker-compose run --rm -e DB_CONNECTION=sqlite -e WARDEN_PRIMARY_KEY_TYPE=ulid -e WARDEN_ACTOR_MORPH_TYPE=ulid -e WARDEN_BOUNDARY_MORPH_TYPE=ulid -e WARDEN_SUBJECT_MORPH_TYPE=ulid php85 vendor/bin/pest --configuration=phpunit.ulid.xml $(ARGS)

test\:docker\:sqlite\:uuid: build
	docker-compose run --rm -e DB_CONNECTION=sqlite -e WARDEN_PRIMARY_KEY_TYPE=uuid -e WARDEN_ACTOR_MORPH_TYPE=uuid -e WARDEN_BOUNDARY_MORPH_TYPE=uuid -e WARDEN_SUBJECT_MORPH_TYPE=uuid php85 vendor/bin/pest --configuration=phpunit.uuid.xml $(ARGS)
...
test\:docker\:mysql\:id: build
	...
	docker-compose run --rm -e DB_CONNECTION=mysql -e DB_HOST=mysql -e DB_PORT=3306 -e DB_DATABASE=warden_test -e DB_USERNAME=root -e DB_PASSWORD=password -e WARDEN_PRIMARY_KEY_TYPE=id php85 vendor/bin/pest $(ARGS)

test\:docker\:mysql\:numeric: build
	docker-compose up -d mysql
	docker-compose run --rm -e DB_CONNECTION=mysql -e DB_HOST=mysql -e DB_PORT=3306 -e DB_DATABASE=warden_test -e DB_USERNAME=root -e DB_PASSWORD=password -e WARDEN_PRIMARY_KEY_TYPE=id -e WARDEN_ACTOR_MORPH_TYPE=numeric -e WARDEN_BOUNDARY_MORPH_TYPE=numeric -e WARDEN_SUBJECT_MORPH_TYPE=numeric php85 vendor/bin/pest --configuration=phpunit.numeric.xml $(ARGS)

test\:docker\:mysql\:ulid: build
	docker-compose up -d mysql
	docker-compose run --rm -e DB_CONNECTION=mysql -e DB_HOST=mysql -e DB_PORT=3306 -e DB_DATABASE=warden_test -e DB_USERNAME=root -e DB_PASSWORD=password -e WARDEN_PRIMARY_KEY_TYPE=ulid -e WARDEN_ACTOR_MORPH_TYPE=ulid -e WARDEN_BOUNDARY_MORPH_TYPE=ulid -e WARDEN_SUBJECT_MORPH_TYPE=ulid php85 vendor/bin/pest --configuration=phpunit.ulid.xml $(ARGS)

test\:docker\:mysql\:uuid: build
	docker-compose up -d mysql
	docker-compose run --rm -e DB_CONNECTION=mysql -e DB_HOST=mysql -e DB_PORT=3306 -e DB_DATABASE=warden_test -e DB_USERNAME=root -e DB_PASSWORD=password -e WARDEN_PRIMARY_KEY_TYPE=uuid -e WARDEN_ACTOR_MORPH_TYPE=uuid -e WARDEN_BOUNDARY_MORPH_TYPE=uuid -e WARDEN_SUBJECT_MORPH_TYPE=uuid php85 vendor/bin/pest --configuration=phpunit.uuid.xml $(ARGS)
...
test\:docker\:postgres\:id: build
	...
	docker-compose run --rm -e DB_CONNECTION=pgsql -e DB_HOST=postgres -e DB_PORT=5432 -e DB_DATABASE=warden_test -e DB_USERNAME=postgres -e DB_PASSWORD=password -e WARDEN_PRIMARY_KEY_TYPE=id php85 vendor/bin/pest $(ARGS)
